...
$ helm upgrade argocd . --install --namespace argocd --values values.customized.yaml --create-namespace

argocd-initial-admin-secret secret value under argocd namespace
Admin password: z1P7R5Pq8TtZ69Qn

Inside argocd-server pod:
$ argocd login argocd-server --username admin --password z1P7R5Pq8TtZ69Qn
$ argocd account update-password \
  --account readonlyuser \
  --new-password Eip1QWUUix01WiEl
  
Repository URL: https://ATP-Tech@dev.azure.com/ATP-Tech/Tradesoft/_git/atp-chatbot-devops-helmcharts
Repository Username: mehmet.kahraman
Repository PAT: 1XDw53meEjqrVARlsUQm5uR3Tyyx2xW6ah3lD4T5ft147xBFPbGRJQQJ99BHACAAAAAFyyhQAAASAZDO4YKw
Expires: 10.08.2026
