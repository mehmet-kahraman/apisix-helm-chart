...
#Customized values are in values.customized.yaml file
$ helm upgrade vault . --install --namespace vault --values values.customized.yaml --create-namespace
```
...
Key shares: 1
Key threshold: 1
Initial Root Token: hvs.ZzD51R5hB6RXOzPCtrEMCs7H
Key 1: JYMaxDoIzDRAKjR02NHK7Oq0DIi9U//tOM6oyU1QLKU=
```

Follow the steps in [this](https://dev.azure.com/ATP-Tech/Tradesoft/_wiki/wikis/GTP.Wiki/75/Vault) link.